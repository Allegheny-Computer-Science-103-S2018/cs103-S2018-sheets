...
your new web site look correct. If it is not, then continue to edit and check it
until the files are correct. As you iteratively complete this assignment, you
should regularly commit files to your GitHub repository, using the ``Git Cheat
Sheet'' and following the steps that are described in the next section. Also,
...
class member and the course instructor and at least one the teaching assistants!

...
``Allegheny-Computer-Science-103-Spring-2018/computer-science-103-spring-2018-practical-5-gkapfham''. Unless you provide
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-103-S2018/computer-science-103-spring-2018-practical-5-gkapfham.git
\end{lstlisting}
...
\begin{figure}[t]
  ...
  \caption{Some of the Segments of the Correct HTML and Source Code.}~\label{fig:correct}
...
and your textbook to carefully determine the root cause of each defect.

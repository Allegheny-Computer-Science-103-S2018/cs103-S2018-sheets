...
student is responsible for finding and reading all of the technical material
needed to successfully design the requested web site. Please see the course
instructor or a teaching assistant if you have questions about these reading
assignments.
...
a dedicated terminal when it is running.

\section*{Checking the Correctness of Your Web Site}

Instead of requiring you to manually check that your deliverables adhere to
these industry-accepted standards, the GatorGrader tool that you will use in
this laboratory assignment makes it easy for you to automatically check if your

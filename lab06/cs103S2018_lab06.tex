...
can review Section 5.1 content in the textbook.
...
to style the \program{<table>} tab and table headers by using the source code
provided in Figure~\ref{fig:css}. Now, you should add more CSS code that will
ensure that all of the cells in the table displayed their textual content in a

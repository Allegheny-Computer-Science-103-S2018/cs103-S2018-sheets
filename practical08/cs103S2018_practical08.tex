...
page 383 of the textbook. Specifically, your web site will feature ten
...
``Allegheny-Computer-Science-103-Spring-2018/computer-science-103-spring-2018-practical-8-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-103-S2018/computer-science-103-spring-2018-practical-8-gkapfham.git
\end{lstlisting}
...
Ultimately, you should aim to make your web site look like an extended version
of the one that is provided on page 383 of the textbook.
...
in the provided source code. Ultimately, you will create a web site that looks
...
ten distinct countries. Finally, you will create a CSS file that styles the
...
(e.g., your web site should feature appropriately styled details about ten
...
automatically check if your submission meets the standards for correctness. To
get started with the use of GatorGrader, type the command \gatorgraderstart{} in
your terminal window. Once this step completes you can type \gatorgradercheck{}.
If your work does not meet all of the assignment's requirements, then you will
see the following output in your terminal: \command{Overall, are there any
mistakes in the assignment? Yes}. If you do have mistakes in your assignment,
then you will need to review GatorGrader's output, find the mistake, and try to
fix it. Once your static web site displays correctly, fulfilling at least some
of the assignment's requirements, you should transfer your files to GitHub using
the \gitcommit{} and \gitpush{} commands. For example, if you want to signal
that the \mainprogramsource{} file has been changed and is ready for transfer to
...
% If you notice that transferring your files to GitHub did not work,
...
feature JavaScript, HTML, and CSS, this practical provides minimal HTML and
JavaScript source code and invites you to add many of the required features
(e.g., new countries and flags). Students do not need to submit printed source
code for this assignment. Instead, this assignment invites you to submit, using
GitHub, the following deliverables. Please see the instructor if you have
questions about this assignment's goals.

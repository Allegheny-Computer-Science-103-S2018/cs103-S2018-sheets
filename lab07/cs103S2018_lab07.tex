...
\newcommand{\assignmentduedate}{March 29}
...
of a \program{<table>} tag and an emoji for each photograph review, additionally
...
``Allegheny-Computer-Science-103-Spring-2018/computer-science-103-spring-2018-lab-7-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-103-S2018/computer-science-103-spring-2018-lab-7-gkapfham.git
\end{lstlisting}
...
travel photographs web site that looks like the one in Figure 3.9. However, now
...
your final web site should look like when completed. Specifically, please note
that this assignment asks you to complete a web site that contains an HTML table
...
\begin{figure}[t]
  ...
  \begin{verbatim}
    ...
    <form action="https://formspree.io/gkapfham@allegheny.edu" method="POST">
      ...
      <!-- Follow instructions to create the rest of the form -->
    </form>
  \end{verbatim}
  \vspace*{-.35in}
...
your form. The second line of source code will ensure that the Formspree system
will ``redirect'' back to your web site after the form is submitted to
Formspree. Additionally, you will see that Figure~\ref{fig:form} provides you
with the source code to display both the labels for the person's name and email
address and then the affiliated input fields. You can learn about all of the
other required form control elements by studying the \command{TODO} markers and
...
ensure proper formatting. Please see the instructor with any questions about
these tasks.
...
of the required components for the interactive survey the reports by email.
...
also be able to explain how you used \program{<br>} and \program{<label>} tags
to correctly format and display the survey content in the form.

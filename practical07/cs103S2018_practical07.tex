...
\newcommand{\secondprogramsource}{\lstinline{images/screenshot.png}}
...
their background while also displaying a provide image in a vertically and
...
textbook, paying particularly close attention to web media and CSS content
...
``Allegheny-Computer-Science-103-Spring-2018/computer-science-103-spring-2018-practical-7-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-103-S2018/computer-science-103-spring-2018-practical-7-gkapfham.git
\end{lstlisting}
...
that both have backgrounds created by CSS gradients and contain a horizontally and

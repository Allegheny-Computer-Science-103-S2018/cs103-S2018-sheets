...
Throughout the semester, you have explored the fundamentals of 


This final project invites you to explore, in greater detail, a real-world
application of web development. You will learn more about how to use, implement,
test, and evaluate different types of software for real-world web sites. Since
you will complete the final project with a team, you will also learn more about
how GitHub and the Git version control system can effectively support

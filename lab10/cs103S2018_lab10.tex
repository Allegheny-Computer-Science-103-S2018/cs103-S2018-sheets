...
\begin{enumerate}
  ...
  \item {\bf International Art Store}: Develop an extension of the ``art store''
    example described in Sections 3.7, 4.8, and 7.9. Your web site should
    feature examples of international art and then descriptions of the artists
    who created the work and the art itself. Your site should feature a
    responsive layout that ensure that art is visible on laptops, desktops, and
    mobile devices.

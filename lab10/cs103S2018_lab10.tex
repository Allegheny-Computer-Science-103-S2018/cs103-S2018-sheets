...
then final approval. Please note that your team is fully responsible for fully
...
\begin{enumerate}
  ...
  \item {\bf International Character Reference}: This topic invites your team to
    ...
    and learn about specific characters.
  ...
  \item {\bf International Art Museum}: Develop an extension of the ``art
    ...
    should feature examples of international art and then descriptions of the
    artists who created the work and the art itself. Your site should feature a
    responsive layout that ensures that both the art and the textual content is
    visible on laptops, desktops, and mobile devices. Whenever possible, the
    site should support user interactivity through, for instance, an art
    discussion board or a zooming display for the artwork.
  ...
  \item {\bf Student-Designed Project}: Students will develop an idea for their
    ...
    web development. After receiving the course instructor's approval for your

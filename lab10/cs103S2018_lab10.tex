...
screenshots of your web site and reports on how your colleagues reacted to your
web site. Here are some additional tips to assist your team while it designs,
implements, and tests the source code of the web site that you create for the
final project:
...
\begin{itemize}
  ...
  \item Use the textbook's description of web development projects to
    assist your when brainstorming.

...
\newcommand{\assignmentduedate}{February 15}
\newcommand{\assignmentassignedate}{February 8}
...
editor''. Next, you will learn how to write an it HTML document that includes
content and tags, specifically investigating the ``travel photographs'' example
in Figure 3.9 of the textbook. Finally, you will learn more about running a web
...
use many of the features that GitHub provides. In particular, make sure that
you have read guides such as ``Mastering Markdown'' and ``Documenting Your
Projects on GitHub''; each of them will help you to understand how to use both
GitHub and GitHub Classroom. To do well on this assignment, you should also
read Chapters 1 and 3 in the course textbook, paying close attention to Section
3.5 and Figure 3.9. Please see the course instructor or a teaching assistant if
...
``Allegheny-Computer-Science-103-Spring-2018/computer-science-103-spring-2018-lab-3-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-103-S2018/computer-science-103-spring-2018-lab-3-gkapfham.git
\end{lstlisting}
...
programming language. Specifically, you will create a travel photographs web
site that looks like the one in Figure 3.9. Please refer to your GitHub
repository for a screenshot that shows what you web site should look like when
completed. To complete this assignment, you should first find an image on Flickr
that is released under a Creative Commons license. Then, you should include that
image in your web site, making sure that you provide a link to the image, the
person who created the image, and the image's license. Moreover, the title of
the web site should be ``Share Your Travels'' and the name of the photograph
should be displayed as a level-two header. Finally, the end of the web site
should contain at least two reviews of the photograph. Students should check the
...
src/www 4250}. At this point, you can start your web browser and go to the
web site \url{http://localhost:4250/travels.html}. Does your new web site look
...
\item A properly formatted and correct version of \mainprogramsource{} that both meets all of the established
  requirements and contains the correct HTML and the desired static web site.

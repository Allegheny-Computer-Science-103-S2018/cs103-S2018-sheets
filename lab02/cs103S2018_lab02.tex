...
about Pandoc. Your introductory paragraph should also acknowledge, this time with a
link to \url{https://github.com/otsaloma/markdown-css}, that you are using
cascading style sheets to influence the display of the generated HTML.

Make sure that you refer to the GitHub Guide for Markdown to learn how to create
headers and links in this file! After you have finished these task, please
continue to edit the following subsections of the web site, explaining your
major and minor and why you want to study web development.

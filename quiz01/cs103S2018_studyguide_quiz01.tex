...
\begin{itemize}
  ...
  \item An understanding of commonly used tags in the HTML (e.g., \program{<head>},
...
\begin{itemize}
  ...
  \item The relationship between CSS and HTML source code in a web site
  ...
  \item The ways to install, configure, and style fonts downloaded from Google's
    font archive
  \item An understanding of font sizes and the units of measurement associated
    with font sizes
  \item How to appropriately use tools to support the development and

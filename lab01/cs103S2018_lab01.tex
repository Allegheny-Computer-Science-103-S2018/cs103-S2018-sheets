...
\begin{lstlisting}
  git clone https://github.com/Allegheny-Computer-Science-103-S2018/computer-science-103-spring-2018-lab-1-gkapfham.git
\end{lstlisting}
...
normally use the text editor called \command{gvim}. Today, you will view and improve your first web site in {\tt gvim}!
To load the source code of today's web site into \program{gvim}, you should type \command{gvim src/www/answers.md} in
your terminal window. This should cause a new window, the \program{gvim} text editor, to appear on your screen. Since
...
this item and indented with four spaces) that furnishes a sentence explaining why you are interested in this role.
...
directory'' of your GitHub repository and type \command{pandoc src/www/answers.md -o src/www/answers.html}. Now, you can
...
and at least one a teaching assistant!
...
\item A properly formatted and correct version of \mainprogramsource{} that both meets all of the established
  requirements and produces the desired web site.
